...
class RencontreParisType extends AbstractType
{
    ...
    {
        $builder->add('idJoueur1', EntityType::class, [
        ...
        if ($builder->getData()->getIdEquipe()->getIdDivision()->getNbJoueursChampDepartemental() > 1) {
            $builder->add('idJoueur2', EntityType::class, [
                'class' => 'App\Entity\Competiteur',
                'choice_label' => function ($competiteur) use ($builder) {
                    return $competiteur->getSelect();
                },
        ...
        if ($builder->getData()->getIdEquipe()->getIdDivision()->getNbJoueursChampDepartemental() > 2) {
            $builder->add('idJoueur3', EntityType::class, [
                'class' => 'App\Entity\Competiteur',
                'choice_label' => function ($competiteur) use ($builder) {
                    return $competiteur->getSelect();
                },
        ...
        if ($builder->getData()->getIdEquipe()->getIdDivision()->getNbJoueursChampDepartemental() > 3) {
            $builder->add('idJoueur4', EntityType::class, [
                'class' => 'App\Entity\Competiteur',
                'choice_label' => function ($competiteur) use ($builder) {
                    return $competiteur->getSelect();
                },
        ...
        if ($builder->getData()->getIdEquipe()->getIdDivision()->getNbJoueursChampDepartemental() > 4) {
            $builder->add('idJoueur5', EntityType::class, [
                'class' => 'App\Entity\Competiteur',
                'choice_label' => function ($competiteur) use ($builder) {
                    return $competiteur->getSelect();
                },
        ...
        if ($builder->getData()->getIdEquipe()->getIdDivision()->getNbJoueursChampDepartemental() > 5) {
            $builder->add('idJoueur6', EntityType::class, [
                'class' => 'App\Entity\Competiteur',
                'choice_label' => function ($competiteur) use ($builder) {
                    return $competiteur->getSelect();
                },
        ...
        if ($builder->getData()->getIdEquipe()->getIdDivision()->getNbJoueursChampDepartemental() > 6) {
            $builder->add('idJoueur7', EntityType::class, [
                'class' => 'App\Entity\Competiteur',
                'choice_label' => function ($competiteur) use ($builder) {
                    return $competiteur->getSelect();
                },
        ...
        if ($builder->getData()->getIdEquipe()->getIdDivision()->getNbJoueursChampDepartemental() > 7) {
            $builder->add('idJoueur8', EntityType::class, [
                'class' => 'App\Entity\Competiteur',
                'choice_label' => function ($competiteur) use ($builder) {
                    return $competiteur->getSelect();
                },
        ...
        if ($builder->getData()->getIdEquipe()->getIdDivision()->getNbJoueursChampDepartemental() > 8) {
            $builder->add('idJoueur9', EntityType::class, [
                'class' => 'App\Entity\Competiteur',
                'choice_label' => function ($competiteur) use ($builder) {
                    return $competiteur->getSelect();
                },
