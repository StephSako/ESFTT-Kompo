function getLastComposAdversaire(nomAdversaire, lienDivision, numeroEquipe) {
    $.ajax({
        ...
        dataType : 'json',
        success : function(responseTemplate) { templatingLastComposAdversaire(numeroEquipe, responseTemplate); },
        error : function() { templatingLastComposAdversaire(numeroEquipe, "<p style='margin-top: 10px' class='pastille reset red'>Le service de la FFTT rencontre des perturbations. Réessayez plus tard</p>"); }
    });
}
